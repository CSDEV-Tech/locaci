    ...
    >
      ...
      >
        ...
        <h2 className="font-regular flex-col px-8 text-center text-base text-white md:text-left lg:flex lg:text-xl">
          <span>
            Nous nous sommes associés avec plusieurs propriétaires certifiés
            pour vous aider à trouver votre prochaine maison
          </span>
...
function MunicipalitiesListSection() {
  ...
  return municipalities.length > 0 ? (
    <section className={clsx("bg-gray/5 px-8 lg:px-16")}>
      ...
      >
        <h2 className={`text-left text-2xl font-bold text-dark md:text-3xl`}>
...
function SectionForWho() {
    ...
    <div className="flex flex-col items-stretch gap-8 lg:items-start">
      <div className="flex flex-col gap-4">
        ...
        <p className="lg:text-lg">
          <span className="font-semibold">LOCACI</span> une application web
          créée par CSDEV TECHNOLOGY qui vous permet de rechercher le logement
          qui vous convient, en fonction de critères que vous aurez saisis,
          parmi un catalogue de bailleurs vérifiés. LOCACI vous permet aussi de
          consulter les détails d'un appartement occupé par le dernier
          locataire, ce qui vous permet de mieux appréhender le bien que vous
          souhaitez louer.
        </p>
      </div>
  ...
  const OwnerContent = () => (
    <div className="flex flex-col items-stretch gap-4 lg:items-start">
      ...
      <p className="lg:text-lg">
        <span className="font-semibold">LOCACI</span> vous offre un outil
        complet pour gérer les annonces de votre logement, créer de manière
        automatisée les documents de votre logement et suivre l'état des lieux
        de celui-ci.
      </p>
      ...
      >
        ...
        >
          ...
          <div className="relative z-20 flex flex-col gap-1.5">
            <p>
              ...
              <strong className="font-bold">très compliqué</strong>
              &nbsp;de trouver un logement. J'ai du passer par les réseaux
              sociaux, des démarcheurs vendeurs d'illusions, tout cet épuisement
              sans trouver le logement qui me correspondait à 100%.
            </p>

            <p>
              C'est pourquoi j'ai rassemblé une équipe pour réfléchir à la
              question : comment faciliter la recherche de logements ? Comment
              avoir accès aux détails des biens proposés ? Et après
              l'acquisition du logement, que se passe-t'il ?
            </p>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            <strong className="text-lg font-semibold">Temomane DE SANZO</strong>
